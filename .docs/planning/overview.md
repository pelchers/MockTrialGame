...
- **Audience-overlays, not separate products:** classroom, competition, and open-play use the same core platform, with only targeted policy or facilitation differences where truly necessary.
