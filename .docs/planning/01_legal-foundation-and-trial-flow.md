# Legal Foundation and Trial Flow

## Research Anchor
The initial legal baseline should use broad U.S. criminal trial structure because it provides the most transferable foundation for later layering:
...
- arraignment / initial appearance concepts
- counsel setup and plea entry
- discovery exchange
- motion practice
- witness and exhibit preparation
- plea negotiation branch
...
- direct, cross, redirect, recross structure
