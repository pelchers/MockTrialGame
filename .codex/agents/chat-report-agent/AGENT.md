---
name: chat-report-agent
description: Generate structured session reports summarizing all work performed during a Claude Code work session.
...
- Track sync status across `.codex`, `.claude`, and any external repositories.
...
### 5. Systems Affected
- Which system docs folders were touched (`.codex/system_docs/`, `.codex/agents/`, `.codex/skills/`).
- Which workflow pipelines were modified or created.
- Whether CLAUDE.md or other root configuration files were updated.

### 6. Sync Status
- What was synced to `.claude` (if trinary sync is active).
...
## Skill Reference
Full workflow details: `.codex/skills/generating-chat-reports/SKILL.md`
